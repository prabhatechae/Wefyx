...
public class Requirement {
    ...
    @Enumerated(EnumType.STRING) private RequirementStatus status = RequirementStatus.SUBMITTED;
    private boolean quotationRequested;
    private BigDecimal estimatedAmount;
    private BigDecimal agreedAmount;
    private Long selectedQuotationId;
    @Enumerated(EnumType.STRING) private QuotationStatus quotationStatus = QuotationStatus.NOT_REQUESTED;
